...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.add_quest.setGeometry(QtCore.QRect(10, 900, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.add_quest.setFont(font)
        self.add_quest.setObjectName("add_quest")
        self.add_info_scr = QtWidgets.QPushButton(parent=self.centralwidget)
        self.add_info_scr.setGeometry(QtCore.QRect(220, 900, 361, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.add_info_scr.setFont(font)
        self.add_info_scr.setObjectName("add_info_scr")
        self.check_file = QtWidgets.QPushButton(parent=self.centralwidget)
        self.check_file.setGeometry(QtCore.QRect(600, 900, 281, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.insert_into_db.setGeometry(QtCore.QRect(900, 900, 211, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.logsTextEdit.setGeometry(QtCore.QRect(13, 780, 1441, 101))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "QT Редактор вариантов"))
        self.dataTextEdit.setPlainText(_translate("MainWindow", "COUNT_OF_QUESTIONS=27\n"
"MAXTIME=0\n"
"KEY=password\n"
"DESCRIPTION=стандартный вариант на 27 вопросов + информационный экран\n"
"I 1730\n"
"IMG=info.png\n"
"Q1 1730\n"
"IMG=1.png, 2.png\n"
